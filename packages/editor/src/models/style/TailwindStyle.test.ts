...
describe(TailwindStyle.name, () => {
  describe("width", () => {
    it("gets width", () => {
      ...
      expect(style.width.value).toEqual({
        type: "keyword",
        keyword: "1/2",
        value: "50%",
      });
  ...
  describe("height", () => {
    it("gets height", () => {
      ...
      expect(style.height.value).toEqual({
        type: "keyword",
        keyword: "1/2",
        value: "50%",
      });
  ...
  describe("color", () => {
    it("gets color", () => {
      ...
      expect(style.color.value).toEqual({
        type: "keyword",
        keyword: "red-500",
        value: "#ef4444",
      });
  ...
  describe("fontSize", () => {
    it("gets fontSize", () => {
      ...
      expect(style.fontSize.value).toEqual({
        type: "keyword",
        keyword: "xl",
        value: "1.25rem",
      });
  ...
  describe("textAlign", () => {
    it("gets textAlign", () => {
      ...
      expect(style.textAlign.value).toEqual({
        type: "keyword",
        keyword: "center",
        value: "center",
      });
    ...
    it("removes textAlign", () => {
      ...
      style.textAlign.value = undefined;
  ...
  describe("radius", () => {
    it("gets radius", () => {
      ...
      expect(style.radius.value).toEqual({
        type: "keyword",
        keyword: "2xl",
        value: "1rem",
      });
